...
Before opening a pull request, please open an issue and discuss whether the change makes sense in SoloLVLdev. Ensuring a cohesive user experience sometimes means we can't include every possible feature or we need to consider the long-term design of how we want to support a feature area.

- For a high-level overview of how SoloLVLdev works, please see the [Architecture Guide](./docs/architecture.md). Understanding the architecture will help ensure your contributions align with the overall design of the project.
...
- For an in-depth overview of the SoloLVLdev codebase, see the DeepWiki documentation
...
Something that I really appreciate are all the non-code contributions, such as reporting bugs, writing feature requests and participating in the community.

## Development

SoloLVLdev is an Electron app.
